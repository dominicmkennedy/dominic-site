...
<div
	class="card variant-ghost card-hover p-4 max-w-lg rounded-xl"
	role="img"
	on:mouseenter={() => {
		mouseOn = true;
	}}
	...
	<a href={`/music/${albumData.mbid}`}>
		<div class="grid grid-cols-5 gap-2">
			<div class="col-span-3 space-y-2">
				...
				{#if albumData.dominicScore}
					<Ratings value={albumData.dominicScore / 2} max={5} justify="justify-left">
			...
			<div class="col-span-2">
				<img src={albumData.coverUrl} alt="" class="rounded-xl" />
			</div>
		</div>

		<div class="table-container pt-2 rounded-xl" class:hidden={!mouseOn}>
